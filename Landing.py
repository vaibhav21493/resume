...
# # Profile pic - fixed path
# image_path = r"D:\resume\profile.jpg"
# if os.path.exists(image_path):
#     st.markdown(f'<img src="data:image/png;base64,{base64.b64encode(open(image_path, "rb").read()).decode()}" class="profile-pic">', unsafe_allow_html=True)
# else:
...
# st.markdown(
#     """
#     <a href="pages/MainPortfolio.py" target="_self" style="text-decoration: none;">
#         <div class="card">
#             🚀 Explore My Portfolio<br><br>
#             See my Education, Skills, Projects, Experience, and Achievements.
#         </div>
#     </a>
#     """,
#     unsafe_allow_html=True
...
if os.path.exists(image_path):
    st.markdown(
        f'<img src="data:image/png;base64,{base64.b64encode(open(image_path, "rb").read()).decode()}" class="profile-pic">',
        unsafe_allow_html=True
    )
else:
    st.markdown('<img src="https://via.placeholder.com/180" class="profile-pic">', unsafe_allow_html=True)
